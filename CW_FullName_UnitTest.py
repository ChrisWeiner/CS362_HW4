...
class TestCaseName(unittest.TestCase):
    ...
    def test3(self):
        self.assertNotEqual(FN.fullName("Chris","Weiner"),"ChrisWeiner")
    def test4(self):
        self.assertNotEqual(FN.fullName("Chris","Weiner"),"Weiner Chris")
    def test5(self):
        self.assertNotEqual(FN.fullName("Chris","Weiner"),"Chris")
    def test6(self):
        self.assertNotEqual(FN.fullName("Chris","Weiner"),"Weiner")
    def test7(self):
        self.assertEqual(FN.fullName("Chris  ","  Weiner"),"Chris Weiner")
    def test8(self):
        self.assertEqual(FN.fullName("     Chris        ","          Weiner          "),"Chris Weiner")
    def test9(self):
        self.assertNotEqual(FN.fullName("Weiner","Chris"),"Chris Weiner")
    def test10(self):
